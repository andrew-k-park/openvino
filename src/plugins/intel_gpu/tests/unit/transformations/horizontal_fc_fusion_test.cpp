...
// Verify that FC horizontal fusion is skipped when FCs have LoRA consumers:
// Add(FC_output, MatMul(Multiply(MatMul(input, A), alpha), B))
// model_ref is identical to model (no transformation applied)
