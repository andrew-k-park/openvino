...
TEST(IncreasePositionIdsPrecisionTest, DirectMatMulSinCos) {
    ...
    auto model = std::make_shared<ov::Model>(ov::OutputVector{sin, cos, shape_of}, ov::ParameterVector{position_ids});
...
TEST(IncreasePositionIdsPrecisionTest, DirectMatMulSinCosPreservesSharedConvertConsumer) {
    ...
    auto model = std::make_shared<ov::Model>(ov::OutputVector{sin, cos, unrelated},
                                             ov::ParameterVector{position_ids});
