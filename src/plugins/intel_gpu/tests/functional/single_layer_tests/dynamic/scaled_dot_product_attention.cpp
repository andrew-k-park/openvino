...
const std::vector<std::vector<InputShape>> dynamic_shapes_3D {
    {
        // q shape
        {ov::test::InputShape{ov::PartialShape{16, -1, 80},
            {ov::Shape{16, 128, 80}}}
        },
        // kv shape
        {ov::test::InputShape{ov::PartialShape{16, -1, 80},
...
const std::vector<std::vector<int64_t>> transpose_value_4D{{0, 1, 2, 3}, {0, 1, 2, 3}, {0, 2, 1, 3}};
...
const auto dynamic_shape_params_4D = testing::Combine(testing::Values(ov::element::f16 /*, ov::element::f32 */),
                                                      ...
                                                      testing::Values(true, false),
                                                      testing::Values(true, false),
                                                      testing::ValuesIn({disable_transpose, transpose_value_4D}));
