...
static constexpr Property<bool, ov::PropertyMutability::RW> force_micro_sdpa_for_pa_mixed{"GPU_FORCE_MICRO_SDPA_FOR_PA_MIXED"};
static constexpr Property<bool, ov::PropertyMutability::RW> disable_micro_sdpa_for_pa_mixed{"GPU_DISABLE_MICRO_SDPA_FOR_PA_MIXED"};
static constexpr Property<bool, ov::PropertyMutability::RW> pa_swa_block_skip_disable{"GPU_PA_SWA_BLOCK_SKIP_DISABLE"};
