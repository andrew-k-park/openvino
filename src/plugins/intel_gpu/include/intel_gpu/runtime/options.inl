...
OV_CONFIG_DEBUG_OPTION(ov::intel_gpu, host_time_profiling, 0, "Host time profiling level: 0 disabled, 1 enqueue, 2 infer phases, 3 detailed enqueue breakdown")
OV_CONFIG_DEBUG_OPTION(ov::intel_gpu, host_time_profiling_iterations, std::set<int64_t>{}, "Network execution iterations for level 3 host time profiling; empty selects all iterations")
