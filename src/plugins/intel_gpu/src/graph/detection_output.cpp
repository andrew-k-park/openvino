...
void detection_output_inst::save(cldnn::BinaryOutputBuffer& ob) const {
    ...
    ob << argument->id;
    ob << cldnn::make_data(&argument->input[0], sizeof(argument->input[0]));
    ob << cldnn::make_data(&argument->input[1], sizeof(argument->input[1]));
    ob << cldnn::make_data(&argument->input[2], sizeof(argument->input[2]));
...
void detection_output_inst::load(cldnn::BinaryInputBuffer& ib) {
    ...
    ib >> id;
    ib >> cldnn::make_data(&input_location, sizeof(input_location));
    ib >> cldnn::make_data(&input_confidence, sizeof(input_confidence));
    ib >> cldnn::make_data(&input_prior_box, sizeof(input_prior_box));
