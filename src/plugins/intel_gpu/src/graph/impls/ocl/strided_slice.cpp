...
public:
    static kernel_params_t get_kernel_params(const kernel_impl_params& impl_param, bool is_shape_agnostic = false) {
        ...
        if (prim->const_inputs_mask & strided_slice::const_input::begin_const) {
        ...
        if (prim->const_inputs_mask & strided_slice::const_input::end_const) {
        ...
        if (prim->const_inputs_mask & strided_slice::const_input::strides_const) {
            ...
            auto stride_layout = impl_param.get_input_layout(input_offset);
        ...
        // if (!impl_param.is_dynamic() && params.striding_params.size() == 3) {
        ...
        //     params.all_constant_inputs = true;
