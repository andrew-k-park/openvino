    ...
    if (is_runtime) {
        ...
        if (user_info.first && user_info.first->is_type<reshape>()) {
            ...
            if (is_axis1_size1_squeeze) {
                ...
                size_t reshape_axis = reshape_ps.size();
                ...
                reshape_lower_sizes[reshape_axis] = lower_sizes[crop_axis] / divider;
                reshape_upper_sizes[reshape_axis] = upper_sizes[crop_axis] / divider;
