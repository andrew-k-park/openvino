...
JitConstants ReorderKernel_bfyx_to_blocked_format::GetJitConstants(const reorder_params& params) const {
    ...
    if (params.output.GetLayout() == DataLayout::bs_fs_yx_bsv16_fsv16 ||
        ...
        params.output.GetLayout() == DataLayout::bs_fs_zyx_bsv16_fsv32 ||
        params.output.GetLayout() == DataLayout::bs_fs_zyx_bsv32_fsv16 ||
        params.output.GetLayout() == DataLayout::bs_fs_zyx_bsv32_fsv32) {
