...
KVCacheCompressionMatcher::KVCacheCompressionMatcher(ov::element::Type compression_dt) {
    ...
    ov::matcher_pass_callback callback = [OV_CAPTURE_CPY_AND_THIS](ov::pass::pattern::Matcher& m) {
        ...
        std::cout << "KVCacheCompressionMatcher::callback | key_cache_node=" << key_cache_node->get_friendly_name()
                  << ", value_cache_node=" << value_cache_node->get_friendly_name() << std::endl;
