...
const std::vector<std::vector<int>> keepTopK = { {50} };//{ {50}, {100} };
const std::vector<std::string> codeType = {"caffe.PriorBoxParameter.CORNER"};//{"caffe.PriorBoxParameter.CORNER", "caffe.PriorBoxParameter.CENTER_SIZE"};
const float nmsThreshold = 0.5f;
const float confidenceThreshold = 0.3f;
const std::vector<bool> clipAfterNms = {true};//{true, false};
const std::vector<bool> clipBeforeNms = {false};//{true, false};
const std::vector<bool> decreaseLabelId = {false};//{true, false};
const float objectnessScore = 0.4f;
const std::vector<size_t> numberBatch = {1};//{1, 2};
