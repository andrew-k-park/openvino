...
class memory_pool {
    ...
    memory_ptr alloc_memory(const layout& layout, allocation_type type, uint32_t network_id);
...
public:
    ...
    memory_ptr get_memory(const layout& layout, allocation_type type, uint32_t network_id);
